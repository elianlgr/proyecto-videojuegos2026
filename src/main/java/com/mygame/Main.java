...
public class Main extends SimpleApplication implements ActionListener {
    ...
    public void simpleInitApp() {
        ...
        sonidoEspada1 = new AudioNode(assetManager,
                "Audio/espada.wav",
                AudioData.DataType.Buffer); // para sonidos así cortitos se usa buffer

        sonidoEspada1.setPositional(false);
        sonidoEspada1.setVolume(0.8f);

        sonidoPaso = new AudioNode(
                assetManager,
                "Audio/paso1.wav"
        );
        sonidoPaso.setPositional(false);
        sonidoPaso.setVolume(0.3f);
    ...
    public void simpleUpdate(float tpf) {
        ...
        if (enEscenario2) {
            ...
            if (dx != 0 || dy != 0) {
                ...
                player.stop();
                tiempoPaso =    0f;
            } // esto es para el sonido de la caminata
